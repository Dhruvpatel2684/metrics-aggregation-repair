...
Reservations that are not confirmed within the protocol handshake window
are considered stale and eligible for sweep.
...
class ConnectionPool:
    ...
    def reserve_slot(self, conn_id, timestamp):
        ...
        Note: Does not check for existing entry — caller is responsible
        for ensuring no duplicate reservations.
        """
